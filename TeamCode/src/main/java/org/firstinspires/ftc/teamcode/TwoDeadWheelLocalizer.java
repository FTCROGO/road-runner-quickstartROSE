...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -12.083343694250368; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -0.8881534534417064; // x position of the perpendicular encoder (in tick units)
    }
