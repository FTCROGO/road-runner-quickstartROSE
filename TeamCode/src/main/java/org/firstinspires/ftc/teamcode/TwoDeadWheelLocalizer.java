...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -0.05123580266451412; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -69.3664765039389; // x position of the perpendicular encoder (in tick units)
    }
